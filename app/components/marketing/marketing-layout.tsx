...
export default function MarketingLayout() {
  ...
  return (
    <div className="bg-surface text-on-surface font-sans min-h-screen flex flex-col">
      ...
      <main
        className="premium-page-shell flex-grow pt-24 sm:pt-28 pb-10 sm:pb-16 px-4 sm:px-6 lg:px-container-padding flex flex-col items-center relative overflow-clip"
        style={{
          background:
      ...
      >
        <div className="premium-gold-sparkle" aria-hidden="true" />
