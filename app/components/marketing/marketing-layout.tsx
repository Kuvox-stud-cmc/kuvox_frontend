...
export default function MarketingLayout() {
  return (
    <div className="bg-surface text-on-surface font-sans min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-20 sm:pt-24 pb-10 sm:pb-16 px-4 sm:px-6 lg:px-container-padding flex flex-col items-center justify-center relative overflow-hidden">
