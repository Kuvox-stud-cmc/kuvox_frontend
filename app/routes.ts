...
export default [
  ...
  ...prefix("teams/:studioId", [
    layout(`${routesFolder.TEAMS}/layout.tsx`, [
      ...
      route("recycle-bin", `${routesFolder.TEAMS}/recycle-bin.tsx`),
      route("assets", `${routesFolder.TEAMS}/assets.tsx`),
      route("collaborate", `${routesFolder.TEAMS}/collaborate.tsx`),
      route("review", `${routesFolder.TEAMS}/review.tsx`),
      route("production", `${routesFolder.TEAMS}/production.tsx`),
      route("ai-tools", `${routesFolder.TEAMS}/ai-tools.tsx`),
      route("brand-kits", `${routesFolder.TEAMS}/brand-kits.tsx`),
    ]),
  ]),
