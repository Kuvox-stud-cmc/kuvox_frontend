...
export type VideoEditorLogEventName =
  ...
  | "editor.media.preparation.start"
  | "editor.media.preparation.success"
  | "editor.media.preparation.failure"
  | "editor.preview.buffering.start"
  | "editor.preview.buffering.end"
